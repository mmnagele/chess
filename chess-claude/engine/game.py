...
class ChessGame:
    ...
    def _is_square_attacked(
        self, board: dict[Position, Piece | None], square: Position, by_color: str
    ) -> bool:
    ...
    def _is_in_check_for_board(self, board: dict[Position, Piece | None], color: str) -> bool:
    ...
    @staticmethod
    def _find_king(board: dict[Position, Piece | None], color: str) -> Position | None:
    ...
    def simulate_move(self, start_pos: Position, end_pos: Position) -> dict[Position, Piece | None]:
        return self._simulate_move(self.board, start_pos, end_pos)

    def find_king_for_board(
        self, board: dict[Position, Piece | None], color: str
    ) -> Position | None:
    ...
    def is_in_check_for_board(self, board: dict[Position, Piece | None], color: str) -> bool:
